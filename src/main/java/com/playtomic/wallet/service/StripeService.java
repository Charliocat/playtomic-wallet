...
public class StripeService {
    ...
    public StripeService(@Value("stripe.simulator.charges-uri") @NonNull URI chargesUri,
                         ...
                         @NotNull RestTemplateBuilder restTemplateBuilder) throws URISyntaxException {
        this.chargesUri = new URI("https://sandbox.playtomic.io/v1/stripe-simulator/charges");
